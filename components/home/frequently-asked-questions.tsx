...
const frequentlyAskedQuestions: FrequentlyAskedQuestionsProps[] = [
  ...
  {
    question:
      "What exactly is included in the initial audit, and how long does it take?",
    answer:
  ...
  {
    question:
      "Will there be any downtime during the setup and integration process?",
    answer:
  ...
  {
    question:
      "How do you handle custom requirements for my specific business needs?",
    answer:
  ...
  {
    question:
      "What happens if I am not satisfied with your service after the first month?",
    answer:
  ...
  {
    question:
      "How do you ensure ongoing accuracy and performance after the initial setup?",
    answer:
  ...
  {
    question:
      "Can I integrate your solutions with my existing marketing tools and platforms?",
    answer:
  ...
  {
    question:
      "What kind of support do I receive after the initial setup is complete?",
    answer:
  ...
  {
    question:
      "What makes your service different from other marketing integration providers?",
    answer:
