  ...
  return (
    ...
    best.
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        />
        <FeatureCard
          icon={<BarChart className="text-primary mb-4 h-12 w-12" />}
        ...
        />
        <FeatureCard
          icon={<CheckCircle className="text-primary mb-4 h-12 w-12" />}
        ...
        />
        <FeatureCard
          icon={<Layers className="text-primary mb-4 h-12 w-12" />}
