...
export default function Offer() {
  ...
  const features02 = [
    {
      ...
      title: "Improve ROAS",
      description:
        "Increase your Return on Ad Spend by up to 30% with precision tracking.",
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        "Ensuring your data is clean and reliable takes constant effort.",
    ...
    },
    {
      ...
      description:
        "Navigating the ever-changing landscape of data regulations.",
  ...
  return (
    <Container className="space-y-6" id="offer">
      <Container className="py-4 space-y-8">
        ...
        <Text as="p" variant="bodyMd">
          ...
          <span className="text-primary font-semibold">
            0 clients, 0 revenue, and a big vision
          </span>
          . I knew nothing about building a SaaS product, but after months of
        ...
        <Text as="p" variant="bodyMd">
          ...
          marketers of the power of precise tracking. But we knew the impact
          accurate data could have on businesses...
        </Text>
        ...
        >
          We wanted to give marketers the clarity and confidence that comes with
        ...
        <Text as="p" variant="bodyMd">
          ...
          confidence. Two years on, we've worked with{" "}
          <span className="text-primary font-semibold">
            over 1,000 companies
          </span>
          , saving them millions in ad spend and unlocking growth they never
          thought possible.
        </Text>
        ...
        <Text as="p" variant="bodyMd">
          ...
          . We've grown from a small startup to a team of dedicated experts, all
          focused on one mission: giving you the most accurate data possible.
        </Text>
      ...
      <Container className="py-4">
        ...
        >
          The Simple{" "}
          <span className="underline text-primary">"Secret" Formula</span> to
          95%+ Tracking Accuracy
        </Text>
        ...
        <Text as="p" variant="bodyMd">
          ...
          consistently, and <span className="font-semibold">optimize ROI</span>{" "}
          in a data-driven way. I've spent{" "}
          <span className="text-primary font-semibold">thousands of hours</span>
          , and over{" "}
          <span className="text-primary font-semibold">
            $100,000 in courses and coaching programs
          </span>{" "}
          to try and find the secret sauce that helps businesses track
        ...
        <Text as="p" variant="bodyMd" className="mb-8">
          ...
          and you'll start to see real, measurable growth in your ROI. You might
          even get messages from people about how your optimized campaigns have
      ...
      <Container className="py-4">
        ...
        <Text as="p" variant="bodyMd">
          ...
          accuracy is probably something you don't have a lot of time to focus
          on.
        </Text>
        ...
        <Text as="p" variant="bodyMd">
          ...
          to manage, or you just don't have 40+ hours a week to devote to
        ...
        <Text as="h2" variant="heading2xl" className="text-xl font-bold mb-4">
