    ...
    <Container className="space-y-6" id="offer">
      <Container className="space-y-8 py-4">
        ...
        <Text as="p" variant="bodyMd">
          ...
          <span className="font-semibold text-primary">100 businesses</span>{" "}
      ...
      <Container className="py-4">
        ...
        >
          The Simple{" "}
          <span className="text-primary underline">"Secret" Formula</span> to
          95%+ Tracking Accuracy
        </Text>
        ...
        <Text as="p" variant="bodyMd">
          ...
          <span className="font-semibold text-primary">thousands of hours</span>
          , and over{" "}
          <span className="font-semibold text-primary">
