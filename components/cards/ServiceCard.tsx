  ...
  <>
   ...
   <div className='flex flex-col gap-1 text-left items-center justify-center'>
    ...
    <Link
     ...
     className='rounded-md px-3 py-2 text-base font-medium shadow-md focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-50 border-2 dark:border-gray-100 border-gray-800 w-full'>
