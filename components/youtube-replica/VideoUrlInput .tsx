 ...
 return (
  <>
   <div className='flex w-full gap-2 px-2 '>
    ...
    <button
     onClick={addVideo}
     className='bg-blue-500 text-white p-2 rounded-full shadow hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 w-40'>
     Add Video
    </button>
   </div>
   {errorMessage && (
