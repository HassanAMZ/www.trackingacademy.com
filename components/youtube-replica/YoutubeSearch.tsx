 ...
 return (
  <div className='flex flex-col lg:flex-row gap-2 w-full px-2'>
   ...
   <button
    ...
    className='bg-blue-500 lg:w-40 w-full text-white p-2 rounded-full shadow hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50'>
    Search
   </button>
   {errorMessage && (
