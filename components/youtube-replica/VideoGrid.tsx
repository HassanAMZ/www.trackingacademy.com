...
const VideoGrid = () => {
  ...
  return (
    <>
      <div className="backgroundOverlay flex flex-col items-center justify-between gap-2 py-2">
      ...
      <div className="grid grid-cols-1 gap-x-4 gap-y-6 py-2 sm:grid-cols-2 lg:grid-cols-4">
