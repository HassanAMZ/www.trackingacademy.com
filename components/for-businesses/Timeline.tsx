 ...
 return (
  <div className='py-10 space-y-8 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px lg:before:mx-auto lg:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-300 before:to-transparent'>
   <TimelineEvent
    ...
    imageULR='/images/for-businesses/timeline-initial-consultation.png'
   ...
   <TimelineEvent
    ...
    imageULR='/images/for-businesses/timeline-audit.png'
   ...
   <TimelineEvent
    ...
    imageULR='/images/for-businesses/timeline-implementation.png'
   ...
   <TimelineEvent
    ...
    imageULR='/images/for-businesses/timeline-testing.png'
   ...
   <TimelineEvent
    ...
    imageULR='/images/for-businesses/timeline-reporting.png'
   ...
   <TimelineEvent
    ...
    imageULR='/images/for-businesses/timeline-optimization.png'
