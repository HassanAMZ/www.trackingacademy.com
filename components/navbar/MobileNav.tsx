  ...
  <div className='sm:hidden '>
   ...
   {navOpen && (
    <section
     ...
     <div
      className={`bg-gray-100 dark:bg-gray-800 h-screen fixed top-0 right-0 left-0 bottom-0 shadow-lg p-4 pt-5 flex flex-row items-start justify-between gap-4`}
      onClick={toggleNav}>
