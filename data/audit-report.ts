...
const auditReports: AuditReport[] = [
  ...
  },
  {
    ...
    recommendedActions: [
      ...
      {
        id: "ensure-proper-consent-config",
  ...
  },
  {
    id: "terapio",
    date: "June 16, 2025",
    embedId: { loom: "358a5937441443d1bdfdedb854dc22ca" },
    ...
    recommendedActions: [
      ...
      {
        id: "recommended-action-consent-config",
        title: "Ensure proper consent configuration",
        categories: ["Compliance"],
        scoreImprovement: 7,
      },
      ...
      {
        id: "recommended-action-cookie-consent-solution",
        title: "Implement a cookie consent solution",
        categories: ["Compliance"],
        scoreImprovement: 15,
      },
  ...
  },
  {
    ...
    recommendedActions: [
      ...
      },
      {
        ...
        title: "Implement cookie consent solution",
        categories: ["Compliance"],
        scoreImprovement: 15,
      },
    ],
  ...
  },
  {
    ...
    recommendedActions: [
      ...
      {
        id: "0196a9c3-bcca-749d-aee6-fcd14f21d041",
        title: "Remove Universal Analytics script",
        categories: ["Advertisement"],
        scoreImprovement: 10,
      },
      {
        id: "0196a9c3-bc60-7199-a6cf-f152eedc662f",
        title: "Check out Matomo server-side tracking",
        categories: ["Analytics"],
        scoreImprovement: 10,
      },
      {
      ...
      {
        id: "0196a9c3-bcd8-72f7-9c4f-917bed22a09e",
        title: "Switch to Taboola server-side tracking",
        categories: ["Advertisement"],
        scoreImprovement: 6,
      },
      {
  ...
  },
  {
    id: "redlightsystems",
    date: "June 14, 2025",
    embedId: { loom: "80d00d4a29694519baeb033fb5f50c20" },
  ...
  },
  {
    ...
    embedId: { loom: "783eed8f849749e08d05e72fb8adc6d9" },
    overallScore: {
      score: 53,
      maxScore: 100,
      status: "Not good",
    ...
    trackingScripts: [
      {
        ...
        category: "Advertisment",
        transferSize: "47 KB",
        transferSizeColor: "var(--green)",
        blockingTime: "58 ms",
        blockingTimeColor: "var(--green)",
      },
      {
        name: "G gtag.js",
        provider: "Google",
    ...
    recommendedActions: [
      {
        id: "action-cookie-duration",
        title: "Bypass ITP limits and extend cookie duration",
        categories: ["Cookies"],
        scoreImprovement: 19,
      },
      {
        id: "action-ad-blockers",
        title: "Avoid negative impact of ad blockers",
