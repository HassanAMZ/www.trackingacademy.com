...
interface Client {
  ...
  testimonial_details: TestimonialDetail[];
  images: Image[];
...
const clientDetails: Client[] = [
  ...
  },
  {
    ...
    project_description: [
      ...
      },
      {
        heading: "How I Helped Them Resolve the Issues",
        description:
          "After understanding their requirements, I collaborated with their development team to configure the data layer object on their websites, enabling us to track user interactions at each funnel step. Further, we employed server-side tracking using stape.io. Throughout our partnership, I've assisted them with over five websites and configured more than 20 funnels using the Facebook Pixel Conversion API and TikTok.",
      },
      {
        heading: "Conclusion",
        description:
    ...
    project_details: [
      {
        heading: "Client's website",
        title: "Equifund Mortgage",
        link: "https://www.equifundmortgage.com/",
      },
      {
        heading: "Website CMS",
        title: "React Js",
  ...
  },
  {
    ...
    business_details: {
      ...
      link: "https://www.linkedin.com/in/david-bodnar-07023580/?originalSubdomain=au",
    },
    client_details: [
      {
    ...
    project_details: [
      {
        heading: "Client's website",
        title: "Comrade",
        link: "https://www.cmrd.com/",
      },
      {
        heading: "Business Type",
        title: "Chrome Extension",
        link: "https://chrome.google.com/webstore/detail/comrade-cash-back-for-you/epjbainekeeehlibhceogbgekgadlbio",
      },
      {
        heading: "Website CMS",
