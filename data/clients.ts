...
const clients: Client[] = [
      ...
      images: [
        {
          ...
          url: '/images/for-businesses/client-buyfreddie-mobile-home.png',
        },
      ],
    },
  ...
  },
  {
    ...
    clientDetails: {
      ...
      images: [{ name: 'profile', url: '/images/clients/matthieu-chauveau.jfif' }],
    },
    businessDetails: {
      email: '',
      phone: '+66902213535',
      ...
      images: [
        {
          name: 'website screenshot',
          url: '/images/for-businesses/client-easyloanapproval-mobile-home.png',
        },
      ],
    },
