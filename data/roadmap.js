const roadmapData = [
  {
    ...
    subItems: [
      ...
      },
      {
        ...
        keyPoints: ['DOM API', 'Rendering pipeline', 'Performance optimizations'],
      },
    ],
  },
  {
    ...
    subItems: [
      {
        ...
        keyPoints: ['Data collection', 'User behavior tracking', 'Insights generation'],
      },
      {
        id: '3-2',
        title: 'Tracking methodologies',
        description: 'Overview of common tracking approaches.',
        keyPoints: ['Pixel tracking', 'JavaScript tracking', 'Server-side tracking'],
      },
      {
        id: '3-3',
    ...
    subItems: [
      {
        ...
        description: 'Measuring the effectiveness of user acquisition strategies.',
        keyPoints: ['Traffic sources', 'Cost per acquisition (CPA)', 'Click-through rate (CTR)'],
      },
      {
        id: '4-2',
      ...
      },
      {
        ...
        keyPoints: ['Retention rate', 'Average order value', 'Repeat purchase rate'],
      },
      {
        id: '4-5',
        title: 'Funnel analysis',
        description: 'Analyzing the performance of conversion funnels.',
        keyPoints: ['Funnel stages', 'Drop-off rates', 'Optimization strategies'],
      },
    ],
  },
  {
    ...
    subItems: [
      ...
      },
      {
        ...
        keyPoints: ['Container configuration', 'Tag management', 'Environment settings'],
      },
      {
        id: '5-3',
        title: 'Tag types',
        description: 'Understanding different types of tags in GTM.',
        keyPoints: ['Google Analytics tags', 'Custom HTML tags', 'Third-party tags'],
      },
      {
        id: '5-4',
        title: 'Triggers and variables',
        description: 'Setting up triggers and variables for tags.',
        keyPoints: ['Trigger conditions', 'Built-in variables', 'Custom variables'],
      },
      {
        id: '5-5',
        title: 'Debug mode',
      ...
      },
      {
        ...
        keyPoints: ['Version history', 'Rollback options', 'Publishing changes'],
      },
    ],
  },
  {
    ...
    subItems: [
      {
        ...
        keyPoints: ['Tag management', 'Integration with Adobe Analytics', 'Custom scripts'],
      },
      {
        id: '6-2',
        title: 'Tealium',
        description: 'Introduction to Tealium for tag management.',
        keyPoints: ['Data layer management', 'Real-time tracking', 'Cross-device integration'],
      },
      {
        id: '6-3',
        title: 'Ensighten',
        description: 'Using Ensighten for advanced tag management.',
        keyPoints: ['Tag governance', 'Privacy compliance', 'Dynamic tag configurations'],
      },
      {
        id: '6-4',
        title: 'Segment',
        description: 'Leveraging Segment for data collection and integration.',
        keyPoints: ['API-driven tracking', 'Destination management', 'Data consistency'],
      },
      {
        id: '6-5',
        title: 'Matomo',
        description: 'Open-source tracking with Matomo.',
        keyPoints: ['Self-hosted analytics', 'Privacy-focused tracking', 'Custom reporting'],
      },
    ],
  },
];
