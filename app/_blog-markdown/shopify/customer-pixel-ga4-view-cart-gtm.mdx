...
1. [Activating Customer Pixels in Shopify](#activating-customer-pixels-in-shopify)
2. [Adding a Custom Pixel for the View Cart Event](#adding-a-custom-pixel-for-the-view-cart-event)
3. [Editing the Code Snippet with Google Tag Manager ID](#editing-the-code-snippet-with-google-tag-manager-id)
4. [Connecting the Pixel with Shopify Backend](#connecting-the-pixel-with-shopify-backend)
5. [Triggering and Testing the View Cart Event](#triggering-and-testing-the-view-cart-event)
6. [Creating GA4 Configuration and Event Tags](#creating-ga4-configuration-and-event-tags)
7. [Testing and Verifying Events on Shopify](#testing-and-verifying-events-on-shopify)
8. [Final Verification in Google Analytics](#final-verification-in-google-analytics)
