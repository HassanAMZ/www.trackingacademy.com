...
2. [Step 1: Adding the Data Layer Event Code](#step-1-adding-the-data-layer-event-code)
...
5. [Step 4: Testing the Facebook Pixel Events](#step-4-testing-the-facebook-pixel-events)
6. [Tracking Add to Cart Events](#tracking-add-to-cart-events)
