export const metadata = {
  title: "WooCommerce Ga4: Purchase Enhanced Ecommerce Event using GTM and DataLayer (Part 5/5)",
  date: "2024-03-21",
  blogId: 98,
  Keywords: `Purchase tracking, google tag manager, google analytics 4, woocommerce analytics, e-commerce data analysis`,
  tags: ["Google Analytics 4", "WooCommerce", "WordPress", "Google Tag Manager", "Purchase"],
  draft: false,
