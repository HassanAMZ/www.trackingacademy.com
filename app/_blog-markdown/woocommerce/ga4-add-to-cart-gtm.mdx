export const metadata = {
  title: 'WooCommerce Ga4: Add to Cart Enhanced Ecommerce Event using GTM and DataLayer (Part 3/5)',
  date: '2024-03-04',
  blogId: 96,
  Keywords: `Add to Cart tracking, google tag manager, google analytics 4, woocommerce analytics, e-commerce data analysis`,
  tags: ['Google Analytics 4', 'WooCommerce', 'WordPress', 'Google Tag Manager', 'Add To Cart'],
  draft: false,
