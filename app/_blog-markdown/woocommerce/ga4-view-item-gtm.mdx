export const metadata = {
  title: 'WooCommerce Ga4: View Item Enhanced Ecommerce Event using GTM and DataLayer (Part 2/5)',
  date: '2024-02-27',
  blogId: 95,
  Keywords: `View Item tracking, google tag manager, google analytics 4, woocommerce analytics, e-commerce data analysis`,
  tags: ['Google Analytics 4', 'WooCommerce', 'WordPress', 'Google Tag Manager', 'View Item'],
  draft: false,
