    ...
    <main className='container-secondary'>
      <section className='pt-6 pb-2 space-y-2'>
        <h1 className='text-center text-3xl md:text-4xl font-semibold '>
          <span className='text-danger'>Get 95% Accurate Tracking</span> in 7
      ...
      <section className=' space-y-3'>
        ...
        <p>
          We make sure your tracking is accurate with an easy setup, full
          testing, and low maintenance. Our system helps you make better
          decisions and increase your profits.
        </p>
        <div className='space-y-3'>
          <h4 className='text-4xl font-semibold text-danger'>
            Fast Implementation
          </h4>
          <p>
            We set up your tracking system in 7 days. Our team handles
            everything to make sure it works smoothly with no downtime.
          </p>
        </div>
        ...
        <div className='space-y-3'>
          ...
          <p>
            Get 95% accuracy, which helps you make better decisions and increase
            your profits. Our system is easy to keep running with low costs.
          </p>
        </div>
        ...
        <div className='space-y-3'>
          ...
          <p>
            Our system is simple and doesn’t need much technical knowledge. It
            grows with your business while staying accurate and efficient.
          </p>
        </div>
        <div className='space-y-3'>
          <h4 className='text-4xl font-semibold text-danger'>
          ...
          <p>
            We are so sure of our process that we guarantee 95% tracking
            accuracy in 7 days, or you get a full refund. Enjoy 24/7 support
            from our customer service team.
          </p>
          <p>
            See the difference our system makes and take your business to the
            next level. Book a free consultation now and secure your spot before
            it’s too late!
          </p>
        </div>
