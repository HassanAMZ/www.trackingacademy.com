export const metadata = {
 ...
 date: "2021-07-21",
 blogId: 1,
 Keywords: `Upwork, Cover Letter, Bigcommerce, Google Tag Manager, Freelancing, Cover Letter Tips, Loom Video, Client Name, Problem Statement, Solution, Expertise, Previous Work, Expected Time, Budget, Similar Job Reference, Web Analytics, DataLayer, Top-Rated Freelancer`,
