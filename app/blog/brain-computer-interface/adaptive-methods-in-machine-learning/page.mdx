export const meta = {
 ...
 draft: false,
 summary:
  "Learning to adapt to the diversity of signals captured by a brain-computer interface is the process of adaptive learning (BCI). We have discussed numerous adaptive learning techniques, which we have divided into two families: those that use statistical decoding and those that rely on generative models.",
