...
Now, we'll implement the script for the Initiate Checkout event:
...
This code initializes the `dataLayer` array if it hasn't been already and renders a specific snippet called 'datalayer-checkout'.
...
This code renders the `head-datalayer` snippet. Depending on the setup of your Shopify theme, this is likely where the head datalayer code resides. Add this code bolow GTM Body Code.
