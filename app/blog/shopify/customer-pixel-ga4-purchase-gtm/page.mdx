export const metadata = {
  title: '[Shopify Customer Pixel] How to Configure GA4 Purchase Event Using Google Tag Manager',
  date: '2024-09-08',
  blogId: 125,
  keywords:
...
1. [Step 1: Ensuring the Data Layer Event Fires](#step-1-ensuring-the-data-layer-event-fires)
2. [Step 2: Adding a Purchase Event Pixel in Shopify](#step-2-adding-a-purchase-event-pixel-in-shopify)
3. [Step 3: Connecting Shopify Data Layer to Google Tag Manager](#step-3-connecting-shopify-data-layer-to-google-tag-manager)
4. [Step 4: Testing Purchase Event Firing in Shopify](#step-4-testing-purchase-event-firing-in-shopify)
5. [Step 5: Setting Up the GA4 Configuration Tag in Google Tag Manager](#step-5-setting-up-the-ga4-configuration-tag-in-google-tag-manager)
6. [Step 6: Creating a Purchase Event Tag in Google Tag Manager](#step-6-creating-a-purchase-event-tag-in-google-tag-manager)
7. [Step 7: Publishing and Testing the Purchase Event](#step-7-publishing-and-testing-the-purchase-event)
