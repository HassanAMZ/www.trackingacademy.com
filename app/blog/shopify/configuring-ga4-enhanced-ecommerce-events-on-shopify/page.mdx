export const metadata = {
 ...
 draft: true,
 description: `In this blog, we are going to explore how you can configure Google Analytics 4 (GA4) for your Shopify store. By the end, you'll understand how to track e-commerce events like "view item", "add to cart", and "purchase" to gain insights into user behavior.`,
 openGraph: {
...
2. Follow the account creation process, naming your property (e.g., "ShahzadaAliHassan").
