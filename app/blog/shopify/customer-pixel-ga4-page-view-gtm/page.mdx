...
<BlogHeader metadata={metadata} /># How to Configure Google Analytics Page View
Event Using Google Tag Manager and Shopify
...
3. [Creating and Configuring a Google Tag Manager Container](#creating-and-configuring-a-google-tag-manager-container)
4. [Connecting Google Tag Manager to Shopify](#connecting-google-tag-manager-to-shopify)
...
8. [Verifying Event Firing in Google Analytics](#verifying-event-firing-in-google-analytics)
9. [Summary and Final Steps](#summary-and-final-steps)
