export const metadata = {
 ...
 draft: true,
 description:
  "A step-by-step guide on how to set up Google Analytics 4' Begin Checkout(begin_checkout) for your Shopify store using Google Tag Manager.",
 openGraph: {
...
<Note
 title='Tip'
 content="Using a custom uncore prefix ensures that the 'begin checkout' does not mix with any other events on your website."
/>
