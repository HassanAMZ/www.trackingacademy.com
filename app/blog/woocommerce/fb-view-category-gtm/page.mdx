...
Here is a blog post based on the video tutorial you provided:

**Configure the View Category Event for Facebook Pixel on Your WooCommerce Store Using Google Tag Manager**
...
**Creating a Tag for the View Category Event (continued):**
