export const metadata = {
  ...
  tags: ['Google Tag Manager', 'WooCommerce', 'Ecommerce Tracking', 'Begin Checkout', 'Google Ads'],
  draft: false,
  description:
...
2. [Installing the GTM Plugin on WordPress](#installing-the-gtm-plugin-on-wordpress)
3. [Verifying GTM Installation](#verifying-gtm-installation)
4. [Setting Up the Begin Checkout Event](#setting-up-the-begin-checkout-event)
5. [Creating Conversion Actions in Google Ads](#creating-conversion-actions-in-google-ads)
6. [Configuring Conversion Tracking Tags](#configuring-conversion-tracking-tags)
7. [Testing and Debugging](#testing-and-debugging)
8. [Publishing Changes](#publishing-changes)
9. [Final Verification and Notes](#final-verification-and-notes)
