export const metadata = {
  ...
  tags: ['Facebook Pixel', 'Google Tag Manager', 'WooCommerce', 'Ecommerce Tracking', 'Page View'],
  draft: false,
  description:
...
<AuthenticatedLayout>
  [Download The GTM Container JSON File](/static/json/FBWooCommerceGTMPageVIew.json).
</AuthenticatedLayout>
