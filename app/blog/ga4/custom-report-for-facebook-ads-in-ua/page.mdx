export const metadata = {
 ...
 blogId: "00005",
 keywords:
  "Custom Report, Facebook ads, UA, iOS14+, traffic acquisition, custom reports, Google Analytics, UTM parameters, data sharing limitations, UTM parameters on Facebook, Facebook dynamic URL, Google Ads URL suffixes, Custom UA Report, google analytics report, Dimensions, Metrics, explorer, flat table, ad content, keyword, medium, sessions, page views, transactions, revenue, Filters, Facebook sales, source, Regex, FacebookAds, Final Report, performance, GiscusComments",
