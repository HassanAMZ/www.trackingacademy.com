...
const mappedClients = clients.map((client) => ({
  ...
  company: {
    ...
    logo:
      client.businessDetails.images[0]?.url ||
      client.clientDetails.images[0].url, // Use fallback if no image
...
const trendCards = [
  {
    ...
    title: "Policies",
    description:
      "are giving people more options to limit how their data is shared with businesses",
  },
  {
    icon: Users,
    title: "People",
  ...
  },
  {
    ...
    title: "Platforms",
    description:
      "are removing identity and grouping the data shared with businesses",
  },
];
